...
public class Meal {
     ...
     * @param image 產品圖片
     */
	public Meal(String name, double price, String image) {
		this.name = name;
		this.price = price;
		this.image = image;
	}
     ...
     * @param describe 產品敘述
     */
	public Meal( String name, double price, String image, String describe) {
		this.name = name;
		this.price = price;
		this.image = image;
	...
	public Meal(int id, String name, double price, String image, String describe) {
		this.id = id;
		this.name = name;
		this.price = price;
		this.image = image;
